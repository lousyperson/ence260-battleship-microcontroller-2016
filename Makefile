...
game.o: game.c init.h constants.h helper.h preparation.h planning.h game_phase.h
	$(CC) -c $(CFLAGS) $< -o $@
...
game_phase.o: game_phase.c game_phase.h ../../drivers/led.h constants.h ../../drivers/avr/system.h ../../utils/pacer.h ../../drivers/navswitch.h ../../utils/tinygl.h ../../drivers/avr/pio.h ../../drivers/avr/ir_uart.h helper.h
	$(CC) -c $(CFLAGS) $< -o $@

helper.o: helper.c helper.h constants.h game_phase.h
	$(CC) -c $(CFLAGS) $< -o $@

planning.o: planning.c planning.h constants.h helper.h game_phase.h
	$(CC) -c $(CFLAGS) $< -o $@

preparation.o: preparation.c preparation.h constants.h helper.h game_phase.h
	$(CC) -c $(CFLAGS) $< -o $@
